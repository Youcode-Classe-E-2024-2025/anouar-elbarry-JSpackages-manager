...
<div class="hidden mt-14 Addversion-modal h-screen sm:ml-64 overflow-x-auto shadow-md sm:rounded-lg px-8">
        ...
        <form action="/submit_author" method="POST">
            <div class="mb-4">
                <label for="name" class="block text-gray-700 font-medium mb-2">Version_number</label>
            ...
            <div class="mb-4">
                <label for="date" class="block text-gray-700 font-medium mb-2">Release_date</label>
            ...
            <div class="mb-4">
                <label for="Authorname" class="block text-gray-700 font-medium mb-2">package name</label>
