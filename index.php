...
<div class="container mx-auto h-full ">
        ...
        <div class="grid grid-cols-1 gap-4 px-4 py-8 md:grid-cols-3 md:h-1/2">
          ...
          <a href="src\controllers\authorController.php" class="card p-6 text-center bg-white rounded shadow hover:shadow-lg self-center min-h-fit h-1/2">
      ...
      <section class="bg-gray-50 dark:bg-gray-900 hidden left-0 top-0 h-screen w-full">
